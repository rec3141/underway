...
def build(root: Path, title: str, links: list[dict], *, tracks_only: bool = False) -> dict:
    ...
    import hashlib
    h = hashlib.sha1()
    for name in ("i18n.js", "i18n-catalog.js", "responsive-header.js", "data.js", "track-data.js", "map.js", "app.js", "tabs.js", "chat.js", "ice.js", "ice.css", "camera-track.js", "photo-gallery.js", "history.js", "nature.js", "feedback.js", "style.css"):
