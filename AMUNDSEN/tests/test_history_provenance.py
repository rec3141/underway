...
class ProvenanceTests(unittest.TestCase):
    ...
    def test_counts_from_a_small_database(self):
        ...
        c.executescript("""
          ...
          CREATE TABLE artifacts (id TEXT, type TEXT, local_file TEXT, source_url TEXT);
        ...
        self.assertEqual((out["counts"]["artifacts"], out["counts"]["artifacts_by_type"], out["counts"]["artifacts_local"], out["counts"]["artifacts_linked"]), (3, {"image": 2, "quote": 1}, 1, 2))
