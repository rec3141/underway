...
run "Rosette"   "$SRC_DATA/Rosette"              "$DEST/Data/Rosette" \
    --include='*/' --include='Logs/*CTD_logbook.csv' --include='Logs/RosetteSheet_*.xlsx' --include='plots/*_raw_data.html' --include='Btl/*.btl' --include='Ladcp/*.lad' --include='Ladcp/*.png' --exclude='*'
